            ...
            <div className="grid gap-4 sm:grid-cols-2">
              <div>
                <label className="mb-1 block text-xs uppercase tracking-wide text-white/40">
                  Scheduled Out <span className="text-amber-400 text-[10px]">(from job)</span>
                </label>
                <input
                  type="datetime-local"
                  className="w-full rounded-lg border border-white/10 bg-zinc-800 px-4 py-2 text-white/70 cursor-not-allowed"
              ...
              <div>
                <label className="mb-1 block text-xs uppercase tracking-wide text-white/40">
                  Expected Return <span className="text-amber-400 text-[10px]">(from job)</span>
                </label>
                <input
                  type="datetime-local"
                  className="w-full rounded-lg border border-white/10 bg-zinc-800 px-4 py-2 text-white/70 cursor-not-allowed"
