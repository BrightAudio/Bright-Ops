              ...
              jobs.map((job) => (
                <tr key={job.id} className="border-b border-zinc-700 hover:bg-zinc-900">
                  ...
                  <td className="px-4 py-2 flex gap-2">
                    <Link href={`/app/warehouse/jobs/${job.id}/prep-sheet`} className="inline-flex items-center gap-1 px-2 py-1 bg-zinc-700 rounded text-amber-300 hover:bg-zinc-600">
                      <FileText size={16} /> Prep
                    </Link>
                    <Link href={`/app/warehouse/jobs/${job.id}/return-manifest`} className="inline-flex items-center gap-1 px-2 py-1 bg-zinc-700 rounded text-green-300 hover:bg-zinc-600">
                      <Undo2 size={16} /> Return
                    </Link>
                    <Link href={`/app/warehouse/jobs/${job.id}/transports`} className="inline-flex items-center gap-1 px-2 py-1 bg-zinc-700 rounded text-blue-300 hover:bg-zinc-600">
