import type { SpeakerType } from '@/lib/types/speaker-designer';
    ...
    <>
      ...
      <div className="grid grid-cols-2 md:grid-cols-6 gap-4 mb-6">
        ...
        <button
          ...
          className="bg-green-600 hover:bg-green-700 text-white px-4 py-4 rounded-lg font-semibold transition-colors flex items-center justify-center gap-2"
        >
          <span>➕</span>
        ...
        <button
          onClick={onAnalyze}
          disabled={isOperating || analyzing || selectedDriversCount === 0}
