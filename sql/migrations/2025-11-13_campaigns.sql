...
CREATE TABLE IF NOT EXISTS public.campaigns (
  ...
  -- Target Audience
  target_status TEXT, -- Filter leads by status (e.g., 'uncontacted')
  target_tags TEXT[], -- Filter leads by tags (future feature)
...
CREATE TABLE IF NOT EXISTS public.campaign_recipients (
  ...
  -- Email Details  
  email_id UUID REFERENCES public.leads_emails(id) ON DELETE SET NULL, -- Link to sent email
...
COMMENT ON TABLE public.campaigns IS 'Email campaigns for bulk lead outreach';
COMMENT ON TABLE public.campaign_recipients IS 'Junction table tracking which leads are in each campaign and their status';
