...
CREATE POLICY IF NOT EXISTS "Allow all access to inventory_movements"
...
CREATE POLICY IF NOT EXISTS "Allow all access to scan_events"
...
CREATE POLICY IF NOT EXISTS "Allow all access to clients"
  ON public.clients
  FOR ALL
  TO public
  USING (true)
...
CREATE POLICY IF NOT EXISTS "Allow all access to jobs"
  ON public.jobs
  FOR ALL
  TO public
  USING (true)
...
CREATE POLICY IF NOT EXISTS "Allow all access to prep_sheets"
...
-- RLS for prep_sheet_items
ALTER TABLE public.prep_sheet_items ENABLE ROW LEVEL SECURITY;

CREATE POLICY IF NOT EXISTS "Allow all access to prep_sheet_items"
...
-- RLS for return_manifest
ALTER TABLE public.return_manifest ENABLE ROW LEVEL SECURITY;

CREATE POLICY IF NOT EXISTS "Allow all access to return_manifest"
  ON public.return_manifest
  FOR ALL
  TO public
  USING (true)
  WITH CHECK (true);
...
CREATE POLICY IF NOT EXISTS "Allow all access to transports"
...
CREATE POLICY IF NOT EXISTS "Allow all access to products"
  ON public.products
  FOR ALL
  TO public
  USING (true)
...
CREATE POLICY IF NOT EXISTS "Allow all access to serials"
  ON public.serials
  FOR ALL
  TO public
  USING (true)
...
CREATE POLICY IF NOT EXISTS "Allow all access to scans"
  ON public.scans
  FOR ALL
  TO public
  USING (true)
...
CREATE POLICY IF NOT EXISTS "Allow all access to sheets"
  ON public.sheets
  FOR ALL
  TO public
  USING (true)
...
CREATE INDEX IF NOT EXISTS idx_sheet_items_serial_id ON public.sheet_items(serial_id);

-- RLS for sheet_items
ALTER TABLE public.sheet_items ENABLE ROW LEVEL SECURITY;

CREATE POLICY IF NOT EXISTS "Allow all access to sheet_items"
  ON public.sheet_items
  FOR ALL
  TO public
  USING (true)
  WITH CHECK (true);
