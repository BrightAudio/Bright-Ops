...
DROP POLICY IF EXISTS "Allow all access to inventory_movements"
...
DROP POLICY IF EXISTS "Allow all access to scan_events"
...
DROP POLICY IF EXISTS "Allow all access to clients"
  ON public.clients
  FOR ALL
  TO public
  USING (true)
...
DROP POLICY IF EXISTS "Allow all access to jobs"
  ON public.jobs
  FOR ALL
  TO public
  USING (true)
...
DROP POLICY IF EXISTS "Allow all access to prep_sheets"
...
DROP POLICY IF EXISTS "Allow all access to prep_sheet_items"
...
DROP POLICY IF EXISTS "Allow all access to return_manifest"
...
DROP POLICY IF EXISTS "Allow all access to transports"
...
DROP POLICY IF EXISTS "Allow all access to products"
  ON public.products
  FOR ALL
  TO public
  USING (true)
...
DROP POLICY IF EXISTS "Allow all access to serials"
  ON public.serials
  FOR ALL
  TO public
  USING (true)
...
DROP POLICY IF EXISTS "Allow all access to scans"
  ON public.scans
  FOR ALL
  TO public
  USING (true)
...
DROP POLICY IF EXISTS "Allow all access to sheets"
  ON public.sheets
  FOR ALL
  TO public
  USING (true)
...
DROP POLICY IF EXISTS "Allow all access to sheet_items"
